 ...
 * 
 * HelloWorld: nome da classe, que tem que ser igual ao nome do arquivo HelloWorld.java
 * 
 ...
 * 
 * main (principal): nome do método, neste case, é o método principal, que irá executar o projeto
 * 
 * ( "abre parênteses": início da declaração de parâmetros e argumentos
 * 
 * String (texto): tipo do parâmetro ou argumento, serve para declarar tipo de variável
 * 
 ...
 * 
 * System (sistema): declaração/invocação da classse "System"
 * 
 * . "ponto": operador de invocação
 * 
 * out (saída): depois do ponto, serve como uma delcaração/invocação da subclasse "out", proveniente da classe "System"
 * 
 ...
 * 
 * "" (aspas dulas): declaração/definição de texto
 * 
 * ; (ponto e vírgula): é a declaração de finalização de lina de código
 * 
